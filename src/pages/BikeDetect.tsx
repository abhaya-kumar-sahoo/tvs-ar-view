...
export const BikeDetect = () => {
  ...
  const Loader = () => (
    <div className="flex flex-col items-center justify-center">
      <div className="w-12 h-12 ml-20 border-4 border-red-600 border-t-transparent rounded-full animate-spin"></div>
    </div>
  );
    ...
    <>
      <div className="relative z-50">
        ...
        {predictions.length > 0 ? (
          <ul className="space-y-2 absolute z-50  top-[45vh] rotate-90">
          ...
          <>
            <div className=" absolute z-50  top-[45vh] ">
              {cameraStarted && <Loader />}
            </div>
          </>
        )}
        {isWebXRSupported && (
